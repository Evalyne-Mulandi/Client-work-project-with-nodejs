...
<h1 class=" text-xl font-bold text-black p-1 font-mono uppercase">{{course.title}}</h1>
<span class=" font-mono text-black">{{course.desc}} </span>
<button class=" m-3 px-4 py-1 bg-gradient-to-r from-black via-teal-900 to-black rounded-full  text-white"> <router-link to="/write">learn more</router-link></button>
...
data(){
 return{
    courses:[ 
        ...
        desc:"  Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus, numquam eveniet dolorum nam officiis eius aperiam adipisci accusamus quam nemo saepe. Nobis doloremque, numquam autem blanditiis esse asperiores atque officia? "
       },
